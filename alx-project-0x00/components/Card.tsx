      ...
      <div className="flex justify-between mt-4">
        <div className=" grid grid-cols-3 border w-[156px] rounded-full px-2 py-1">
          ...
          <div className="flex items-center">
            ...
            <p className="ml-1 text-[12.95px] font-medium">6 Nights</p>
          </div>
          <div className="flex items-center">
            <p className="font-medium text-[12.95px] ml-1">From</p>
            <p className="font-medium text-[12.95px] text-[#131212]">Rp 7,839,000</p>
          </div>
        </div>
      </div>
    </div>
